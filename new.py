...
findtext = re.compile(r'<div class="post-p" style="display: inline-block" data-v-eb458b72>(.*)</div>')
    ...
    for img_url in range(0,len(imgurl)):
        ...
        for item in soup.find_all('div', class_="blur-img"):
            ...
            for j in range(0, len(link)):
                ...
                num = num + 1
        # for j in soup.find_all('div', class_="post-p"):
        #     j = str(j)
        #     text = re.findall(findtext, j)
